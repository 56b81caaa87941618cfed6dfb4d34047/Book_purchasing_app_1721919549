...
*/
Vue.component("simple_footer_component_1721919551", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BookBazaar - Your Online Book Haven
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Discover your next great read at BookBazaar. Browse our vast collection, get personalized recommendations, and enjoy hassle-free shopping. Happy reading!
                    </div>
                </div>
            </div>
        </footer> 
